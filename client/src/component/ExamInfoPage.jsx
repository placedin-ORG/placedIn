...
const ExamInfoPage = () => {
  ...
  const confirmStart = () => {
    ...
    try {
      let url = `http://localhost:5173/finalExam/${userId}/${courseId}`;
...
<div className="w-full h-screen bg-slate-100 flex items-center justify-center p-6 md:p-12">
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start w-full max-w-4xl border-2 rounded-3xl shadow-lg bg-white overflow-hidden">
    ...
    <div className="w-full md:w-1/2 p-6 md:p-10">
      <h1 className="text-2xl font-bold text-gray-800 mb-4">Instructions</h1>
      <ul className="list-disc list-inside text-gray-700 space-y-2">
        <li>
          <span className="text-red-500 font-medium">Ensure you have watched the full course</span> and gained all necessary knowledge before proceeding.
        </li>
        <li>
          <span className="text-red-500 font-medium">Do not exit full screen</span>. Exiting will cause the exam to automatically submit.
        </li>
        <li>
          Cheating is strictly prohibited. Maintain focus and integrity during the exam.
        </li>
      </ul>
      <button
