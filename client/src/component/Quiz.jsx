    ...
    <>
      <div className="space-y-6 pr-4 pb-5">
        ...
        {selectedQuiz.map((question, questionIndex) => (
          console.log(console.log("sel"),selectedOptions[[questionIndex]]),
          console.log(console.log("cor"),question),


          <div key={questionIndex} className="bg-white shadow-lg rounded-lg p-6">
            {/* Question */}
            <p className="text-lg font-semibold text-gray-800 ">
              {/* Note: Your question object has 'question', not 'questionText' */}
              {`Q: ${question.question}`}
            </p>
            ...
            <div className="space-y-3 mt-4">
              ...
              {/* --- THIS IS THE CORRECTED ANSWER BLOCK --- */}
              {condition && (
