const TopSection=()=>{
   ...
   <div className="flex flex-col md:flex-row items-center justify-between p-6 bg-gradient-to-r ">
      ...
      <div className="pl-0 md:pl-10 flex flex-col items-start text-center md:text-left md:w-1/2 space-y-4">
        <h1 className="text-3xl md:text-5xl font-bold animate-fade-in">Unlock <span className='text-green-400'>Opportunity</span></h1>
      ...
      <img src="https://d8it4huxumps7.cloudfront.net/uploads/images/676e5f765e786_internship_portal.png?d=1000x600"/>
